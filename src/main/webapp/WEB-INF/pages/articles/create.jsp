...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">${action} article</li>
        </ol>
    </div>
    <!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">${action} article</h1>
        </div>
    </div>
    <!--/.row-->
    <div class="row">
        <div class="col-lg-9">
            <form:form role="form" commandName="article" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="checkbox">
                            <c:forEach items="${categories}" var="category" varStatus="loopStatus">
                                <label>
                                    <c:choose>
                                        <c:when test="${article.categories.contains(category)}">
        ...
        <div class="col-lg-3">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="panel-footer">
                            ...
                            <a href="/post/${article.id}/delete" class="btn btn-danger">Remove</a>
            ...
            <div class="row">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table">
                            <c:forEach items="${article.oldVersions}" var="article">
                                <tr>
                                    <td>
                                            ${article.date}
                                    </td>
                                    <td>
                                        <a href="/article/${article.id}/restore">View</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
